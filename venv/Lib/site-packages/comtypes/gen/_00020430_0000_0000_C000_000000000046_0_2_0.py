...
__all__ = [ 'OLE_COLOR', 'IPicture', 'IFontEventsDisp',
           'OLE_XPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE', 'IPictureDisp',
           'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS',
           'LoadPictureConstants', 'FONTBOLD', 'Checked',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_CONTAINER', 'IFont',
           'Color', 'Monochrome', 'OLE_CANCELBOOL', 'Font',
           'StdPicture', 'FONTNAME', 'StdFont', 'FONTSTRIKETHROUGH',
           'Unchecked', 'Gray', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'FONTSIZE', 'OLE_XPOS_HIMETRIC',
           'FONTITALIC', 'OLE_XPOS_PIXELS', 'VgaColor', 'Picture',
           'OLE_OPTEXCLUSIVE', 'Default', 'OLE_XSIZE_PIXELS',
           'FontEvents', 'IFontDisp', 'OLE_YPOS_PIXELS', 'OLE_HANDLE',
           'FONTUNDERSCORE']
from comtypes import _check_version; _check_version('1.1.10', 1641657974.591257)
